                ...
                <Header androidStatusBarColor={'transparent'} style={{backgroundColor:'#fefefe'}}>
                    ...
                    <Right>
                        <Button transparent    onPress={()=> Actions.message({title:'消息'})}>
                            <Thumbnail  style={{width:17,height:17}} source={Config.IECEIVESOCKET==1?require('../img/icon_account_warn.png'):require('../img/icon_account_warn.png')} />
                        ...
                        >
                            <Thumbnail   style={{width:17,height:17}} source={require('../img/icon_account_setting.png')} />
                        </Button>
                    </Right>
                </Header>
