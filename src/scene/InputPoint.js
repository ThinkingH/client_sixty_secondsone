...
export default  class InputPoint extends Component {
    constructor(props) {
        super(props);
        this.state = {
            value: this.props.valuepoint ? this.props.valuepoint : "",

        };
        _value = this.props.valuepoint ? this.props.valuepoint : "";
    }
    ...
    componentWillUnmount() {
        Storage.saveWithKeyValue("valuepoint", _value);
        this.props.callbackpoint({valuepoint: _value});
    }
